  ...
  <div className="w-full lg:w-1/3 flex items-center justify-center bg-gray-50 p-6 font-poppins">
        ...
        >
          <div className="text-center mb-6 flex flex-col gap-2">
            <img src="/images/form-logo.svg" alt="Logo" className="mx-auto w-16 h-16 lg:w-20 lg:h-20" />
            <h2 className="text-3xl  text-purple-500 tracking-widest font-extralight ">Welcome to <br/><span className="tex-2xl text-purple-700 font-semibold">Ques.AI</span></h2>
          </div>
          ...
          <p className="text-center text-sm mt-4">
            Already have an account? <Link  to="/signin" className="text-purple-600 hover:underline">Login in</Link>
          </p>
        </form>
      </div>
    </div>
